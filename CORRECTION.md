...
| v | 目次2.4.2 | Long-Short Term Memoty -> Long Short-Term Memory |  |
...
| p21 | 最終行 | 再起的 -> 再帰的 | 第3刷 |
| p22 | 下から7行目 | ベクトル$h'\_i$をSoftmax変換 -> ベクトル$h'\_(i-1)$をSoftmax変換 |  |
| p24 | 2.4.2項見出し | Long-Short Term Memoty -> Long Short-Term Memory |  |
...
| p135 | 下から1行目| ここでで -> ここで |  |
| p156 | 箇条書き1つめ| categry -> category |  |
